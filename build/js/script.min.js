...
"use strict";$(document).ready(function(){svg4everybody(),setTimeout(function(){$(".b-shape").removeClass("b-shape_hidden")},500),$(document).on("click",".b-navbar__btn",function(e){e.preventDefault();var t=$("body");t.hasClass("b-navbar-opened")?t.removeClass("b-navbar-opened"):t.addClass("b-navbar-opened")});var r=r||{};function e(){var e=$("body"),t=$(".b-hero"),o=$(".b-navbar");if(t.length&&o.length){var a=t.offset().top,n=t.outerHeight(),i=$(this).scrollTop();a+n-o.outerHeight()<i?e.addClass("b-header-highlight"):e.removeClass("b-header-highlight")}}r.state=!1,$(document).on("click",'.js-anchor-nav .nav-link[href^="#"]',function(e){r.state=!0,e.preventDefault();var t=$(".b-navbar").outerHeight(),o=$(this),a=o.closest(".js-anchor-nav"),n=o.closest(".nav-item"),i=o.attr("href");a.find(".nav-item").removeClass("active"),"991"<$("body").width()?n.addClass("active"):$("body").removeClass("b-navbar-opened");if(void 0!==i&&""!==i&&$(i).length){var s=$(i).offset().top;$("html, body").animate({scrollTop:s-t},900)}setTimeout(function(){r.state=!1},900)}),$(window).on("scroll resize",function(){if("991"<$("body").width()){if(r.state)return;var s=$(".b-navbar").outerHeight(),e=$("body").find("[id]");$(".js-anchor-nav .nav-item").removeClass("active"),$(e).each(function(){var e=$(window).scrollTop()+s+1,t=$(this).outerHeight(),o=$(this).attr("id"),a=$('.js-anchor-nav .nav-link[href="#'+o+'"]'),n=$(this).offset().top,i=$(this).offset().top+t;n<e&&e<i&&a.closest(".nav-item").addClass("active").siblings("nav-item").removeClass("active")})}else $(".js-anchor-nav .nav-item").removeClass("active")}),e(),$(window).on("scroll",e),$(document).on("click",".js-anchor",function(e){e.preventDefault();var t=$(".b-navbar").outerHeight();$("html, body").animate({scrollTop:$($.attr(this,"href")).offset().top-t},800)});var a=$(".b-carousel");function t(){var e=a.find(".carousel-inner"),t=a.find(".carousel-item"),o=0;t.each(function(){$(this).outerHeight()>o&&(o=$(this).outerHeight())}),e.height(o)}t(),$(window).resize(function(){t()}),a.on("touchstart",function(e){var o=e.originalEvent.touches[0].pageX;$(this).one("touchmove",function(e){var t=e.originalEvent.touches[0].pageX;5<Math.floor(o-t)?$(this).carousel("next"):Math.floor(o-t)<-5&&$(this).carousel("prev")}),$(this).on("touchend",function(){$(this).off("touchmove")})}),$(".modal").on("show.bs.modal",function(e){$("body").removeClass("b-navbar-opened")})});